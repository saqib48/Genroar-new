      ...
      <div className='flex  list-none items-center gap-[60px]  '>
            ...
            <div className="flex mb-[20px]   ">
              <div className="">
                <ul className="pr-[120px] border-r grid gap-[8px] s  ">
                  <li className=" text-[15px]  "><AnchorTag ><b>Shops Layout</b></AnchorTag></li>
              ...
              <div className="">
                <ul className="pr-[120px] border-r grid gap-[8px] ml-[40px]  ">
                  <li className=" text-[15px]  "><AnchorTag ><b>Other Pages</b></AnchorTag></li>
                  ...
                  <li><AnchorTag href="/myaccount" variant="success" >My Account</AnchorTag></li>
                </ul>
              </div>
              <div className="">
                <ul className="pr-[120px] border-r grid gap-[8px] ml-[40px]  ">
              ...
              <div className="">
                <ul className="pr-[120px] grid gap-[8px] ml-[40px]  ">
                  <li className=" text-[15px]  "><AnchorTag ><b>Collection</b></AnchorTag></li>
        ...
        <li><AnchorTag variant='Header' href='/'>Pages<IoIosArrowDown /></AnchorTag>
          <ul className='dropdown  absolute bg-white opacity-5 z-[9999] invisible py-[10px] pr-[80px] pl-[30px]'>
            ...
            <li><AnchorTag variant='Headerh' href='/compare'>Compare</AnchorTag></li>
